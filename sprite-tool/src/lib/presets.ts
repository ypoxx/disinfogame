// ===========================================
// PROMPT PRESETS
// Vordefinierte Prompts für Räume, NPCs und Elemente
// Basierend auf MADTV_STYLE_SYSTEM.md
// ===========================================
...
// ===========================================
// STYLE ANCHOR - Kernelemente für alle Prompts
// ===========================================
...
const NPC_PRESETS: Preset[] = [
  {
    ...
    name: 'Hacker (Idle)',
    nameDE: 'Hacker (Ruhig)',
    description: '4-Frame Idle-Animation des Hackers',
    assetType: 'sprite',
...
Side view. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'npc_hacker_typing',
    name: 'Hacker (Typing)',
    nameDE: 'Hacker (Tippt)',
    description: '6-Frame Tipp-Animation des Hackers',
    assetType: 'sprite',
...
Side view. ${STYLE_ANCHOR.technical}.`,
  ...
  },
  {
    id: 'npc_analyst_idle',
    name: 'Analyst (Idle)',
    nameDE: 'Analystin (Ruhig)',
    description: '4-Frame Idle-Animation der Analystin',
    assetType: 'sprite',
...
${STYLE_ANCHOR.colors}. Transparent background. Side view. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'npc_analyst_reading',
    name: 'Analyst (Reading)',
    nameDE: 'Analystin (Liest)',
    description: '4-Frame Lese-Animation der Analystin',
    assetType: 'sprite',
    prompt: `A 4-frame pixel art sprite sheet of a female intelligence analyst reading documents.
Age 35-45, professional blazer, glasses, concentrated expression.
Reading animation: turning pages, adjusting glasses, making notes.
Horizontal layout, 64x64 pixels per frame. ${STYLE_ANCHOR.base}.
${STYLE_ANCHOR.colors}. Transparent background. Side view. ${STYLE_ANCHOR.technical}.`,
    tags: ['npc', 'analyst', 'reading', 'animation'],
  },
  {
    id: 'npc_media_idle',
    name: 'Media Specialist (Idle)',
    nameDE: 'Medien-Spezialist (Ruhig)',
    description: '4-Frame Idle-Animation des Medien-Spezialisten',
    assetType: 'sprite',
...
Side view. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'npc_media_talking',
    name: 'Media Specialist (Talking)',
    nameDE: 'Medien-Spezialist (Spricht)',
    description: '6-Frame Sprech-Animation des Medien-Spezialisten',
    assetType: 'sprite',
    prompt: `A 6-frame pixel art sprite sheet of a media specialist talking/presenting.
Male, age 35-45, fashionable suit, confident gestures.
Talking animation: mouth movement, hand gestures, expressive face.
Horizontal layout, 64x64 pixels per frame. ${STYLE_ANCHOR.base}.
${STYLE_ANCHOR.colors}. Transparent background. Side view. ${STYLE_ANCHOR.technical}.`,
    tags: ['npc', 'media', 'talking', 'animation'],
  },
  {
    id: 'npc_general_idle',
    name: 'General (Idle)',
    nameDE: 'General (Ruhig)',
    description: '4-Frame Idle-Animation des Generals',
    assetType: 'sprite',
...
${STYLE_ANCHOR.colors}. Transparent background. Side view. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'npc_general_nodding',
    name: 'General (Nodding)',
    nameDE: 'General (Nickt)',
    description: '4-Frame Nick-Animation des Generals',
    assetType: 'sprite',
    prompt: `A 4-frame pixel art sprite sheet of a Soviet military general nodding.
Male, age 55-65, military uniform with medals, grey hair, stern expression.
Nodding animation: slow deliberate nod, maintaining eye contact.
Horizontal layout, 64x64 pixels per frame. ${STYLE_ANCHOR.base}.
${STYLE_ANCHOR.colors}. Transparent background. Side view. ${STYLE_ANCHOR.technical}.`,
    tags: ['npc', 'general', 'nodding', 'animation'],
  },
];

// ===========================================
// PLAYER-PRESETS (Sprite-Sheets)
// ===========================================
const PLAYER_PRESETS: Preset[] = [
  {
    id: 'player_idle',
    name: 'Player (Idle)',
    nameDE: 'Spieler (Ruhig)',
    description: '4-Frame Idle-Animation des Spielers',
    assetType: 'sprite',
...
${STYLE_ANCHOR.colors}. Transparent background. Side view. ${STYLE_ANCHOR.technical}.`,
  ...
  },
  {
    id: 'player_walk',
    name: 'Player (Walk)',
    nameDE: 'Spieler (Gehen)',
    description: '8-Frame Geh-Animation des Spielers',
    assetType: 'sprite',
...
${STYLE_ANCHOR.colors}. Transparent background. Side view. ${STYLE_ANCHOR.technical}.`,
  ...
  },
  {
    id: 'player_climb',
    name: 'Player (Climb)',
    nameDE: 'Spieler (Klettern)',
    description: '6-Frame Kletter-Animation für Treppe/Aufzug',
    assetType: 'sprite',
    prompt: `A 6-frame pixel art sprite sheet of a Soviet bureaucrat climbing stairs.
Male, age 40-50, grey or dark blue suit, briefcase.
Climbing animation: stepping up motion, hand on railing.
Horizontal layout, 64x64 pixels per frame. ${STYLE_ANCHOR.base}.
${STYLE_ANCHOR.colors}. Transparent background. Side view. ${STYLE_ANCHOR.technical}.`,
    tags: ['player', 'climb', 'stairs', 'animation'],
  },
];

// ===========================================
// ELEMENT-PRESETS (Props)
// ===========================================
const ELEMENT_PRESETS: Preset[] = [
  {
    id: 'element_crt_monitor',
    name: 'CRT Monitor',
    nameDE: 'Röhrenmonitor',
    description: 'Alter CRT-Monitor mit grünem Text',
    assetType: 'element',
...
${STYLE_ANCHOR.base}. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'element_rotary_phone',
    name: 'Rotary Phone',
    nameDE: 'Wählscheiben-Telefon',
    description: 'Altes Telefon mit Wählscheibe',
    assetType: 'element',
...
${STYLE_ANCHOR.base}. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'element_red_phone',
    name: 'Red Phone (Hotline)',
    nameDE: 'Rotes Telefon (Hotline)',
    description: 'Das berühmte rote Telefon',
    assetType: 'element',
    prompt: `A pixel art game asset: the famous red telephone hotline.
Soviet-era design, bright red color, no dial (direct line), heavy construction,
coiled cord. Symbol of power. 32x32 pixels. Transparent background.
${STYLE_ANCHOR.base}. ${STYLE_ANCHOR.technical}.`,
    tags: ['element', 'phone', 'command'],
  },
  {
    id: 'element_filing_cabinet',
    name: 'Filing Cabinet',
    nameDE: 'Aktenschrank',
    description: 'Grauer Metall-Aktenschrank',
    assetType: 'element',
...
${STYLE_ANCHOR.base}. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'element_server_rack',
    name: 'Server Rack',
    nameDE: 'Server-Rack',
    description: 'Server-Schrank mit blinkenden LEDs',
    assetType: 'element',
...
${STYLE_ANCHOR.base}. Neon green and red LED accents. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'element_propaganda_poster',
    name: 'Propaganda Poster',
    nameDE: 'Propaganda-Poster',
    description: 'Sowjetisches Propaganda-Plakat',
    assetType: 'element',
...
Transparent background. ${STYLE_ANCHOR.base}. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'element_desk_lamp',
    name: 'Desk Lamp',
    nameDE: 'Schreibtischlampe',
    description: 'Grüne Bankerlampe',
    assetType: 'element',
    prompt: `A pixel art game asset: vintage banker's desk lamp.
Soviet-era design, brass base, green glass shade, pull chain,
warm glow effect. 32x48 pixels. Transparent background.
${STYLE_ANCHOR.base}. ${STYLE_ANCHOR.technical}.`,
    tags: ['element', 'furniture', 'lamp'],
  },
  {
    id: 'element_tv_set',
    name: 'Television Set',
    nameDE: 'Fernseher',
    description: 'Alter Röhrenfernseher',
    assetType: 'element',
...
// ===========================================
// AMBIENT ANIMATION PRESETS
// ===========================================
const AMBIENT_PRESETS: Preset[] = [
  {
    id: 'ambient_fan',
    name: 'Spinning Fan',
    nameDE: 'Drehender Ventilator',
    description: '4-Frame Ventilator-Animation',
    assetType: 'sprite',
...
Grey metal color. Transparent background. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'ambient_screen_flicker',
    name: 'Screen Flicker',
    nameDE: 'Bildschirm-Flackern',
    description: '4-Frame Monitor-Flacker-Animation',
    assetType: 'sprite',
...
Neon green (#00FF00) glow. Transparent background. ${STYLE_ANCHOR.technical}.`,
  ...
  {
    id: 'ambient_blinking_led',
    name: 'Blinking LEDs',
    nameDE: 'Blinkende LEDs',
    description: '4-Frame LED-Blink-Animation',
    assetType: 'sprite',
    prompt: `A 4-frame pixel art sprite sheet of blinking server LEDs.
Row of small LEDs in red and green, random blinking pattern.
Animation: alternating blink states. Horizontal layout, 32x16 pixels per frame.
Transparent background. ${STYLE_ANCHOR.technical}.`,
    tags: ['ambient', 'led', 'tech', 'animation'],
  },
  {
    id: 'ambient_neon_flicker',
    name: 'Neon Light Flicker',
    nameDE: 'Neonröhren-Flackern',
    description: '4-Frame Neonlicht-Animation',
    assetType: 'sprite',
    prompt: `A 4-frame pixel art sprite sheet of a flickering fluorescent tube light.
Soviet-era ceiling light, slight color variation, occasional full flicker.
Animation: subtle flicker with occasional off frame. Horizontal layout,
64x16 pixels per frame. Pale white/blue glow. Transparent background.
${STYLE_ANCHOR.technical}.`,
    tags: ['ambient', 'light', 'flicker', 'animation'],
  },
];
...
export function getPresetsForCategory(categoryId: string): Preset[] {
