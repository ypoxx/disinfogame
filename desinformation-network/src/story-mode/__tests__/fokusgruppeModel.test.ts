...
const POP: Persona[] = [
  { id: 'lena', name: 'Lena', gruppe: 'Optimisten', segmentId: 'optimiererin', bio: '', vulnerabilities: ['FOMO'], receptivity: { hope: 0.8, fear: 0.0, anger: -0.6, trust: 0.4 } },
  { id: 'walter', name: 'Walter', gruppe: 'Mitte', segmentId: 'besorgte_mitte', bio: '', vulnerabilities: ['Abstiegsangst'], receptivity: { hope: -0.2, fear: 0.8, anger: 0.1, trust: -0.3 } },
  { id: 'doreen', name: 'Doreen', gruppe: 'Abgehängte', segmentId: 'zorniger', bio: '', vulnerabilities: ['Empörung'], receptivity: { hope: -0.7, fear: 0.2, anger: 0.9, trust: -0.8 } },
];
