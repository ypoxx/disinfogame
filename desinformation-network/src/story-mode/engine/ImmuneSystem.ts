...
/** Lärm: Risiko-Kosten der eigenen Aktionen → Abwehr-Zufluss. */
export const NOISE_RISK_FACTOR = 0.10;
/** Lärm: Aufmerksamkeits-Zuwachs der eigenen Aktionen → Abwehr-Zufluss. */
export const NOISE_ATTENTION_FACTOR = 0.06;
/** Passiver Zuwachs je Summe Verteidiger-Stärke und Tag. */
export const DEFENDER_FACTOR = 0.35;
...
export const BASELINE_PER_DAY = 0.15;
/** „Gepatcht": Abwehr-Sprung, wenn eine Maschen-Familie durchschaut wird. */
