...
| V10 | **G23-Altlasten:** eigene Seite referenzierte real „Moskau/Kreml/Genosse/Wodka/Russisch/Vaterland" | widerspricht „fiktiver Ost-Block, keine realen Symbole" | **✅ 28 Stellen entschärft** (→ „die Zentrale" etc.) in dialogues/topics/insert/npcs/consequences/countermeasures | **Offen (G24):** `world-events.json` „Russian minority / Soviet monument" fiktionalisieren (bilingual, Grammatik) |
| V11 | **Reaktions-Texte in Steckbrief-Stimme** (P1b) | Begrüßungen fertig | **✅ Direktor + Marina** Reaktionen neu vertont (role-aligned) | **Offen:** Alexei/Katja/Igor-Reaktionen tragen noch ALTE Persona-Kategorien (Alexei=Chaos, Katja=Content, Igor=Hacker) → brauchen **Re-Theme + Re-Trigger + Voice** (mit dem Rollen-Roster); + Topic-Texte |
